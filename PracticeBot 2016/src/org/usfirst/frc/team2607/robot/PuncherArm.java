...
//	private final double armRotatorMaxSpeed = 18.0;  // cim rotations per second, for motion profiles
	...
	public PuncherArm(){
		...
		shooterCocked = new DigitalInput(Constants.plungerLimiter);
		...
		punchLock = new Solenoid(1,Constants.brakeSolenoid);
		santaClaw = new Solenoid(1,Constants.clawSolenoid);
		armLocker = new Solenoid(1,Constants.plungerHook);
