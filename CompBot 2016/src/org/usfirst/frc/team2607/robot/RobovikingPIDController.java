 ...
 */
public class RobovikingPIDController implements PIDInterface, LiveWindowSendable {
  ...
  private class PIDTask extends TimerTask {
    ...
    private RobovikingPIDController m_controller;

    public PIDTask(RobovikingPIDController controller) {
      if (controller == null) {
   ...
   *        default is 50ms.
   */
  public RobovikingPIDController(double Kp, double Ki, double Kd, double Kf, PIDSource source,
   ...
   *        default is 50ms.
   */
  public RobovikingPIDController(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output,
      double period) {
...
// FIXED:  moved from within previous block, so that m_result gets calculated even when Kp is 0
